#!/bin/bash
export app='react-zalo-widget' # container & image name
path_app="$HOME/react-zalo-widget"
gitProjectName="react-zalo-widget"
gitProjectUrl="git@github.com:DaoHuyTuan/react-zalo-widget.git"
gitBranch="master"
